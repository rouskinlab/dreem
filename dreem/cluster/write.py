...
def write_results(loader: CallVecLoader,
...
def write_tables(dfs: dict[int, pd.DataFrame], loader: CallVecLoader,
...
def write_table(df: pd.DataFrame, loader: CallVecLoader,
