...
if __name__ == '__main__':
    ...
    fastq1 = [os.path.join(root_dir + '474DMS', f) for f in os.listdir(root_dir + '474DMS') if f.endswith('R1.fastq')]
    fastq2 = [os.path.join(root_dir + '474DMS', f) for f in os.listdir(root_dir + '474DMS') if f.endswith('R2.fastq')]
    fastq1.sort(), fastq2.sort()    
    out_dir = root_dir +'474DMS_output'
    rnastructure_path = '/Users/ymdt/src/RNAstructure/exe'
    fasta = root_dir +'reference.fasta'
    samples_names = ['474DMS']
