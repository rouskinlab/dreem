...
def get_config(arguments):
  return {
    ...
    'demultiplexing':{
      'use': arguments['demultiplexing']['use'],
      'input': input_folder(),
      'temp': temp_folder()+'/demultiplexing',
      'output': output_folder()+'/demultiplexing'
    },
    'alignment':{
      'input': output_folder()+'/demultiplexing' if arguments['demultiplexing']['use'] else input_folder(),
    ...
    'clustering':{
      'use': arguments['clustering']['use'],
      'input': output_folder()+'/vectoring',
      'temp': temp_folder()+'/clustering',
      'output': output_folder()+'/clustering'
    },
    'aggregate':{
      'input': output_folder()+'/clustering' if arguments['clustering']['use'] else output_folder()+'/vectoring',
      'temp': temp_folder()+'/aggregate',
      'output': output_folder()+'/aggregate'
    },
    'post_processing':{
      'use': arguments['post_processing']['use'],
